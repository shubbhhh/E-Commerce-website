...
export function Profile() {
    ...
    return (
        ...
        <div className="p-5 h-full">
                <div className="flex justify-between m-6 p-4 rounded-md shadow-lg border border-black">
                    <div className="flex justify-center gap-6">
                        ...
                        <div className="rounded-md drop-shadow-lg text-md">
                            ...
                            <div className="flex gap-4 pt-2">
                                <button className="flex flex-col justify-center items-center rounded-md border border-transparent p-2 box-content text-neutral-700 hover:shadow-xl hover:bg-zinc-200">
                    ...
                    <div className="flex flex-col justify-center items-center gap-5 border-l-2 p-5">
